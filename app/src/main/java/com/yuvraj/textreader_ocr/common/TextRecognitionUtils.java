...
public class TextRecognitionUtils {
    ...
    public void recognizeText(Bitmap bitmap, final CameraScannerActivity activity) {
...
//                                    }
                                ...
                                activity.showTextFromImage(text, null);
                                // [END get_text]
                                // [END_EXCLUDE]
                            }
                        })
    ...
    public void recognizeTextCloud(FirebaseVisionImage image) {
    ...
    public FirebaseVisionDocumentTextRecognizer getLocalDocumentRecognizer() {
    ...
    public FirebaseVisionDocumentTextRecognizer getCloudDocumentRecognizer() {
    ...
    public void processDocumentImage() {
        // Dummy variables
    ...
    public void processDocumentTextBlock(FirebaseVisionDocumentText result) {

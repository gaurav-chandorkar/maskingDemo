...
public class CameraSource {
    ...
    public String mFlashMode = "", mFocusMode = "";
...
//        }
     ...
     * @return {@code true} if the flash mode is set, {@code false}
     */
    public boolean setFlashMode(String mode) {
        if (camera != null && mode != null) {
            Camera.Parameters parameters = camera.getParameters();
            if (parameters != null && parameters.getSupportedFlashModes() != null && parameters.getSupportedFlashModes().contains(mode)) {
     ...
     * @return {@code true} if the focus mode is set, {@code false}
     */
     ...
     */
    public void autoFocus(@Nullable Camera.AutoFocusCallback cb) {
        if (camera != null) {
    ...
    public boolean setAutoFocusMoveCallback(@Nullable Camera.AutoFocusMoveCallback cb) {
    ...
    public class CameraAutoFocusCallback implements Camera.AutoFocusCallback {
        private Camera.AutoFocusCallback mDelegate;

        @Override
        public void onAutoFocus(boolean success, Camera camera) {
            if (mDelegate != null) {
                mDelegate.onAutoFocus(success, camera);
            }
        }
    }
    ...
    public class CameraAutoFocusMoveCallback implements Camera.AutoFocusMoveCallback {
        private Camera.AutoFocusMoveCallback mDelegate;

        @Override
        public void onAutoFocusMoving(boolean start, Camera camera) {
            if (mDelegate != null) {
                mDelegate.onAutoFocusMoving(start, camera);
            }
        }
    }
